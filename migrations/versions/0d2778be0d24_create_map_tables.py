...
Revision ID: 0d2778be0d24
Revises: 407554a1fdaf
Create Date: 2021-07-04 01:20:18.890358
...
def upgrade():
    ...
    op.create_table('subscription_schedules',
                    ...
                    sa.ForeignKeyConstraint(['pre_sales_id'], ['pre_sales.id'], ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id'),
