...
def upgrade():
    ...
    op.add_column('public_sale_details', sa.Column('hallway_type', sa.String(length=3), nullable=True))
    op.add_column('public_sale_details', sa.Column('bay', sa.SmallInteger(), nullable=True))
    op.add_column('public_sale_details', sa.Column('plate_tower_duplex', sa.String(length=2), nullable=True))
    op.add_column('public_sale_details', sa.Column('kitchen_window', sa.String(length=1), nullable=True))
    op.add_column('public_sale_details', sa.Column('cross_ventilation', sa.String(length=1), nullable=True))
    op.add_column('public_sale_details', sa.Column('alpha_room', sa.String(length=1), nullable=True))
    op.add_column('public_sale_details', sa.Column('cyber_house_link', sa.String(length=200), nullable=True))
