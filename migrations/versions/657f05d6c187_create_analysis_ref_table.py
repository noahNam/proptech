...
def upgrade():
    op.create_table(
        ...
        sa.Column("multiple_children_competition", sa.Integer(), nullable=True),
        sa.Column("newly_marry_competition", sa.Integer(), nullable=True),
        sa.Column("old_parent_competition", sa.Integer(), nullable=True),
        sa.Column("first_life_competition", sa.Integer(), nullable=True),
        ...
        sa.Column("normal_competition", sa.Integer(), nullable=True),
