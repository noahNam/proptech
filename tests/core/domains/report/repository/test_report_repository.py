...
from core.domains.report.entity.report_entity import PredictedCompetitionEntity, TicketUsageResultEntity
...
def test_get_expected_competition_then_return_ticket_usage_result_entity(
    ...
    ] = ReportRepository().get_ticket_usage_result_of_house(user_id=user_id, house_id=house_id)
