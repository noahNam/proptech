...
def upgrade():
    ...
    op.add_column(
        "public_sales", sa.Column("hhld_total_cnt", sa.Integer(), nullable=True)
    )
    op.add_column(
        "public_sales", sa.Column("park_total_cnt", sa.Integer(), nullable=True)
    )
    op.add_column(
        "public_sales", sa.Column("highest_floor", sa.SmallInteger(), nullable=True)
    )
    op.add_column("public_sales", sa.Column("dong_cnt", sa.Integer(), nullable=True))
    op.add_column(
...
def downgrade():
    ...
    op.drop_column("public_sales", "dong_cnt")
    op.drop_column("public_sales", "highest_floor")
    op.drop_column("public_sales", "park_total_cnt")
    op.drop_column("public_sales", "hhld_total_cnt")
