...
from core.domains.house.entity.house_entity import BindSuccessSupplyAreaEntity


# todo. AddSupplyAreaUseCase에서 사용 -> antman 이관 후 삭제 필요
class TempSuccessSupplyAreaModel(db.Model):
    __tablename__ = "temp_success_supply_area"
    ...
    def to_entity(self) -> BindSuccessSupplyAreaEntity:
        return BindSuccessSupplyAreaEntity(
            id=self.id,
