...
from core.domains.user.entity.user_entity import UserInfoEntity, UserInfoCodeValueEntity, UserInfoResultEntity
...
class UserInfoModel(db.Model):
    ...
    def to_entity(self) -> UserInfoEntity:
        return UserInfoEntity(user_profile_id=self.user_profile_id, code=self.code, value=self.value, )
