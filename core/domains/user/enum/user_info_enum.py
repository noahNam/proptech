...
class CodeStepEnum(Enum):
    ONE = [1000, 1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 1010, 1011, 1012, 1013, 1014, 1015, 1016, 1017,
           1018, 1019]
...
class MonthlyIncomeEnum(Enum):
    ...
    # 2020년 외벌이 기준
    COND_CD_1 = [50, 70, 80, 100, 110, 120, 130, 140]
    COND_NM_1 = []

    # 2020년 맞벌이 기준
    COND_CD_2 = [50, 80, 110, 120, 130, 140, 160]
    COND_NM_2 = []
