...
class Config:
    ...
    # Ironman service
    IRONMAN_SERVICE_URL = os.environ.get("IRONMAN_SERVICE_URL") or "https://ironman.apartalk.com"
...
class LocalConfig(Config):
    ...
    #     "postgresql+psycopg2://tanos:***REMOVED***@localhost:5432/tanos"
    # )
    SQLALCHEMY_DATABASE_URI = (
        "postgresql+psycopg2://toadhome_tanos:Ska!rl##gur*2214"
        "@noah-snap-tanos-cluster.cluster-csv9jankq8eq.ap-northeast-2.rds.amazonaws.com:5432/tanos"
    )
    # Prod migrate
