...
class SetRedisUseCase:
    ...
    def execute(self) -> None:
        ...
        data = dict(id=900000, public_sale_details_id=106986, region='해당지역900', region_percent=900, win_point=900)
        ...
        data = dict(public_sale_details_id=106986, region='해당지역999', region_percent=999, win_point=999)
