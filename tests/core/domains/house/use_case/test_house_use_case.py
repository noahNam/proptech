...
from core.domains.house.dto.house_dto import UpsertInterestHouseDto, CoordinatesRangeDto, GetHousePublicDetailDto, \
    GetCalenderInfoDto
from core.domains.house.entity.house_entity import PublicSaleCalenderEntity, CalenderInfoEntity
...
from core.domains.house.use_case.v1.house_use_case import UpsertInterestHouseUseCase, BoundingUseCase, \
    GetHousePublicDetailUseCase, GetCalenderInfoUseCase
...
def test_get_house_public_detail_use_case_when_enable_public_sale_house(session,
    ...
    with patch(
        ...
        with patch(
            ...
            result = GetHousePublicDetailUseCase().execute(dto=get_house_public_detail_dto)
...
def test_get_house_public_detail_use_case_when_disable_public_sale_house(session,
                                                                         create_interest_house,
                                                                         create_real_estate_with_public_sale):
    """
...
def test_get_calender_info_use_case_when_included_request_date(session, create_real_estate_with_public_sale):
    """
...
def test_get_calender_info_use_case_when_no_included_request_date(session, create_real_estate_with_public_sale):
    """
        get_calender_info_by_get_calender_info_dto -> return mocking
