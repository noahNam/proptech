...
def upgrade():
    op.add_column('administrative_divisions',
                  sa.Column('apt_trade_price', sa.Integer(), nullable=False, server_default="0"))
    op.add_column('administrative_divisions',
                  sa.Column('apt_deposit_price', sa.Integer(), nullable=False, server_default="0"))
    op.add_column('administrative_divisions',
    ...
    op.create_index(op.f('ix_administrative_divisions_back_legal_code'), 'administrative_divisions',
                    ['back_legal_code'], unique=False)
    op.create_index(op.f('ix_administrative_divisions_front_legal_code'), 'administrative_divisions',
                    ['front_legal_code'], unique=False)
    ...
    op.add_column('real_estates',
                  sa.Column('front_legal_code', sa.String(length=5), nullable=False, server_default="00000"))
    op.add_column('real_estates',
                  sa.Column('back_legal_code', sa.String(length=5), nullable=False, server_default="00000"))
...
def downgrade():
    ...
    op.add_column('administrative_divisions',
                  sa.Column('real_trade_price', sa.INTEGER(), autoincrement=False, nullable=False))
    op.add_column('administrative_divisions',
                  sa.Column('real_rent_price', sa.INTEGER(), autoincrement=False, nullable=False))
    op.add_column('administrative_divisions',
                  sa.Column('real_deposit_price', sa.INTEGER(), autoincrement=False, nullable=False))
