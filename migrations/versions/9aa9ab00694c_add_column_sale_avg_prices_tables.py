...
def upgrade():
    op.add_column(
        ...
        sa.Column("max_trade_contract_date", sa.String(length=8), nullable=True),
    )
    op.add_column(
        "private_sale_avg_prices",
        sa.Column("max_deposit_contract_date", sa.String(length=8), nullable=True),
    )

    op.add_column(
        "public_sale_avg_prices",
        sa.Column("avg_competition", sa.SmallInteger(), nullable=True),
    )
    op.add_column(
        "public_sale_avg_prices",
    ...
    op.add_column(
        "private_sale_avg_prices",
        sa.Column("pyoung_div", sa.String(length=1), nullable=True),
    )
