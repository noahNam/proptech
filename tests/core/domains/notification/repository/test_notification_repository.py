...
def test_get_notification_repo_when_my_category_history_then_two_result(
...
def test_get_notification_repo_when_official_category_history_then_one_result(
    create_users, create_notifications
):
...
def test_get_notification_repo_when_my_category_history_then_none(
    create_users, create_notifications
):
    topics = [
        NotificationTopicEnum.SUB_NEWS.value,
...
def test_get_receive_notification_settings_then_success(create_users):
    result = NotificationRepository().get_receive_notification_settings(
        user_id=create_users[0].id
    )
...
def test_create_receive_notification_history_when_change_push_status_then_success(
